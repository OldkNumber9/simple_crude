...
DROP TABLE IF EXISTS `coe140101`;
CREATE TABLE IF NOT EXISTS `coe140101` (
...
(1, 'Nita Hunt', '1-462-532-4815', 'ac@google.couk', 'Philippines', '$39.28'),
...
(51, 'Oldk', '123456789', 'tanakathefirst@gmail.com', 'Thailand', '฿10.20');
COMMIT;
